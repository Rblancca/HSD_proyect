...
data class NextDaysResponse (
	...
	@SerializedName("temperatura") val temperatura : TemperatureResponse
	...
	override fun toDomain(): WeatherNextDays = WeatherNextDays(attributes.periodo,temperatura.max, temperatura.min)
}